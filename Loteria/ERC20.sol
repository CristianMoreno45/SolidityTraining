...
interface IERC20{
    ...
    //Devuelve un valor booleano resultado de la operación indicada, se asume que el sender es el dueño de la operación
    function transfer(address recipient, uint256 amount) external returns (bool);
    
    //Devuelve un valor booleano resultado de la operación indicada
    function transferBase(address sender, address recipient, uint256 amount) external returns (bool);
...
contract ERC20Basic is IERC20{
    ...
    string public constant name = "JUJI";
    string public constant symbol = "JJC";
    ...
    function transfer(address recipient, uint256 numTokens) public override returns (bool){
        return transferBase(msg.sender, recipient,numTokens);
    }

    function transferBase(address sender, address recipient, uint256 numTokens) public override returns (bool){
